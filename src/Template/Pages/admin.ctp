...
<br>
    <div class="row">
        <div class="slick-slide col-md-2">
            <br>
        ...
        <div class="slick-slide col-md-2">
            <br>
            <a href="/users/users" class="titoloAdmin"><h4>Utenti</h4></a>
            <br>
            <a href="/users/users" style="margin-left:50px;"><img src="/img/admin/users.png" class="img-responsive icona"></a>
        </div>
        <div class="slick-slide col-md-2">
            <br>
