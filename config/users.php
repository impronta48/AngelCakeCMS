...
$config = [
  ...
  'Auth' => [
    ...
    'AuthenticationComponent' => [
      'load' => true,
      'loginRedirect' => '/',       //Quando faccio login mando alla home del sito
  ...
  'OAuth' => [
    'providers' => [
      'auth0' => [
        ...
        'className' => 'Riskio\OAuth2\Client\Provider\Auth0',
        'mapper' => '\App\Mapper\Auth0',
        'options' => [
          'redirectUri' => Router::fullBaseUrl() . '/auth/auth0',
          'linkSocialUri' => Router::fullBaseUrl() . '/link-social/auth0',
          'callbackLinkSocialUri' => Router::fullBaseUrl() . '/callback-link-social/auth0',
        ],
      ],
      'facebook' => [
        'service' => 'CakeDC\Auth\Social\Service\OAuth2Service',
