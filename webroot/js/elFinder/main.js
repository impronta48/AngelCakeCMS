...
(function(){
	...
	var // jQuery and jQueryUI version
		...
		start = function(elFinder, editors, config) {
			// load jQueryUI CSS
			elFinder.prototype.loadCss('/css/ui-lightness/jquery-ui-1.8.18.css');
	...
	require.config({
      ...
      'jquery-ui': '/js/node_modules/jquery-ui/build/release',
      'elfinder' : '/js/elFinder/js/elfinder.min',
	...
	if (! require.defined('elFinderConfig')) {
		define('elFinderConfig', {
			...
			defaultOpts : {
				url : '/percorsi/ckeconnector' // connector URL (REQUIRED)
				,commandsOptions : {
					edit : {
						extraOptions : {
